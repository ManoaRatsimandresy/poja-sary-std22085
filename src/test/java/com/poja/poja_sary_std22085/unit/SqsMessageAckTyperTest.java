package com.poja.poja_sary_std22085.unit;
...
import com.poja.poja_sary_std22085.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "com.poja.poja_sary_std22085.endpoint.event.gen.UuidCreated", payload);
